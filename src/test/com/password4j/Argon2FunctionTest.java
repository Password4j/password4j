...
public class Argon2FunctionTest
{
    ...
    private static final List<TestCase> CASES = Arrays.asList(
            ...
            new TestCase("mini", "12345678", 3, 1, 4, 1,
    ...
    public void test()
    {
        ...
        {
            Argon2Function f = Argon2Function.getInstance(test.memory, test.iterations, test.parallelism, test.outLength, test.type);
    ...
    public void parallelTest() throws InterruptedException, ExecutionException
    {
        ...
        {
            Callable<Boolean> c = () -> test.expected.equals(Argon2Function.getInstance(test.memory, test.iterations, test.parallelism, test.outLength, test.type).hash(test.plainTextPassword, test.salt).getResult());
            tasks.add(c);
        }
